...
<Library LVVersion="10008000">
	...
	<Item Name="Global Strings.vi" Type="VI" URL="../Global Strings.vi"/>
	<Item Name="Agilent 364xA (GPIB,Serial) Main Page.vi" Type="VI" URL="../Agilent 364xA (GPIB,Serial) Main Page.vi"/>
	<Item Name="Agilent 364xA (GPIB,Serial) Initialization VI.vi" Type="VI" URL="../Agilent 364xA (GPIB,Serial) Initialization VI.vi"/>
	<Item Name="Agilent 364xA (GPIB,Serial) RT Driver VI.vi" Type="VI" URL="../Agilent 364xA (GPIB,Serial) RT Driver VI.vi"/>
	<Item Name="Get Properties.vi" Type="VI" URL="../Get Properties.vi"/>
	<Item Name="Print Text.vi" Type="VI" URL="../Print Text.vi"/>
	<Item Name="Clear Specific Error.vi" Type="VI" URL="../Clear Specific Error.vi"/>
	<Item Name="Print CD Error.vi" Type="VI" URL="../Print CD Error.vi"/>
</Library>
